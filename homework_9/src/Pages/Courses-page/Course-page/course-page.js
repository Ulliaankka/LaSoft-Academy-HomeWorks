...
const CoursePage = () => {
    ...
    return (
        <>{data ? <div className="single-course-page">
            ...
            <div className="course-text-block">
                ...
                <div className="form-content">
                    <ul>
                        {CoursePage?.description_full.map((el, i) => {
                            return <li key={i} className="general-text course-describe-list">{el}</li>
                        })}
                    </ul>
                </div>
                ...
                <Button text='Apply now' castomClassName='btn-apply-size' color='green' onClick={() => applyCourse(CoursePage)} />
            </div>
