        ...
        <div className='courses-page-wrap'>
            ...
            <div className="all-cards">
                {data && data.courses.map((el) => {
                    return <div key={el.id} className="card" onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        navigate(`/courses/${el.id}`);
                    }}>
                        
                        <img className="course-image" src={el.thumbnail_img_url} alt="course_picture" />
                        ...
                        <div className="card-content">
                            ...
                            <Button text='Apply' color='green' castomClassName='btn-courses-apply' onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                                applyCourse(el);
                            }
