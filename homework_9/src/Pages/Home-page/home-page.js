            ...
            <div className="container">
                <div className="block">
                    <div className="decription">
                        ...
                        <span className="general-text left-small-text">Our school has more than 20 years of experience in teaching people who always thought that they 
                        ...
                        <ul className="general-text left-list">
                            ...
                            <Button text='Apply now' castomClassName='btn-apply-size' color='green' onClick={() => navigate("/apply")} />
                    </div>
                ...
                <div className="block reverse-block">
                    ...
                    <div className="decription">
                        ...
                        <p className="general-text home-text-section">Subscribe to our newsletter to stay tuned and get hottest updates and deals</p>
                        <Button text='Subscribe' color='white' onClick={() => setVisible(true)}/>
