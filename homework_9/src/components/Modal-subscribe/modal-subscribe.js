                ...
                <div className='modal-window'>
                    <div className='modal-window-text'>
                        ...
                        <div className='modal-close-window'>
                            <img src={Close_button} onClick={() => setVisible(false)} alt='Close the modal window' />
                        </div>

                        <div className='modal-input-field'>
                            <div className="modal-main-text">
                                <h2 className='modal-text-center'>Give us your email to stay tuned!</h2>
                                <div className="modal-form">
                                    <input 
                                        ...
                                        id='subscribe-value' 
                                    /> 
                                    <Button castomClassName='btn-subscribe-size' color='green' onClick={function () {
                                        setVisible(false);
                                        postRequest({ email: `${document.getElementById('subscribe-value').value}` });
                                    }
                                    } text="Subscribe" type='submit'></Button>
                                </div>
                            </div>
                    ...
                    <div className='modal-right-img'><img src={modalImage} alt='Image of arts' /></div>
                </div>
            </div>
        )
    } else {
